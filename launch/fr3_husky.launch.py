...
def generate_launch_description():
    ...
    mujoco_ros_sim_node = Node(
        ...
        parameters=[
            ...
            PathJoinSubstitution([FindPackageShare('dyros_robot_menagerie'), 'config', 'fr3_husky_gain.yaml']),
    ...
    urdf_path = os.path.join(get_package_share_directory('dyros_robot_menagerie'), 'robot', 'fr3_husky.urdf')
    srdf_path = os.path.join(get_package_share_directory('dyros_robot_menagerie'), 'robot', 'fr3_husky.srdf')
