...
def generate_launch_description():
    ...
    mujoco_ros_sim_node = Node(
        ...
        parameters=[
            ...
            ## Python controller
            # {'controller_class': 'dyros_robot_menagerie/FR3HXLSControllerPy'},
            PathJoinSubstitution([FindPackageShare('dyros_robot_menagerie'), 'config', 'fr3_xls_gain.yaml']),
        ],
    ...
    urdf_path = os.path.join(get_package_share_directory('dyros_robot_menagerie'), 'robot', 'fr3_xls.urdf')
    srdf_path = os.path.join(get_package_share_directory('dyros_robot_menagerie'), 'robot', 'fr3_xls.srdf')
