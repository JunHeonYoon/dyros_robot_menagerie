...
def generate_launch_description():
    ...
    mujoco_ros_sim_node = Node(
        ...
        output='screen',
        parameters=[
            {'robot_name': 'dual_fr3_husky'},
            ## C++ controller
            {'controller_class': 'dyros_robot_menagerie/DualFR3HuskyController'},
            ## Python controller
            # {'controller_class': 'dyros_robot_menagerie/DualFR3HuskyControllerPy'},
            PathJoinSubstitution([FindPackageShare('dyros_robot_menagerie'), 'config', 'dual_fr3_husky_gain.yaml']),
    ...
    urdf_path = os.path.join(get_package_share_directory('dyros_robot_menagerie'), 'robot', 'dual_fr3_husky.urdf')
    srdf_path = os.path.join(get_package_share_directory('dyros_robot_menagerie'), 'robot', 'dual_fr3_husky.srdf')
    ...
    gui_node = Node(
        ...
        executable='DualFR3HuskyControllerQT',
        name='DualFR3HuskyControllerQT',
        output='screen',
        emulate_tty=True,
    )
    ...
    teleop_twist_joy_node = Node(
        ...
        remappings=[
            ('cmd_vel', '/dual_fr3_husky_controller/cmd_vel'),
        ],
    )
