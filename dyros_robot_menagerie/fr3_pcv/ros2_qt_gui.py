...
class Ros2QtGui(Node, QWidget):
    def __init__(self, topic_ns: str = 'fr3_pcv_controller'):
    ...
    def _build_right_feedbacks(self):
        ...
        gj = QGridLayout()
        self.joint_edits = {}
        wheel_names = ['front_left_rotate', 'front_right_rotate', 'rear_left_rotate', 'rear_right_rotate',
                       'front_left_steer',  'front_right_steer',  'rear_left_steer',  'rear_right_steer',]
...
def main():
    ...
    gui = Ros2QtGui(topic_ns='fr3_pcv_controller')
    gui.show()
    try:
        exit_code = app.exec_()
    finally:
