...
class Ros2QtGui(Node, QWidget):
    def __init__(self, topic_ns: str = 'fr3_husky_controller'):
        Node.__init__(self, 'ros2_qt_gui')
        QWidget.__init__(self)
        self.setWindowTitle('FR3-Husky Controller GUI — Compact Full')
        self.setMinimumWidth(760)   # compact width but two columns
...
def main():
    ...
    gui = Ros2QtGui(topic_ns='fr3_husky_controller')
    gui.show()
    try:
        exit_code = app.exec_()
    finally:
