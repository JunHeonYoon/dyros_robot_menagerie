...
----+----------------------+--------+----+----+-------+------
  ...
  5 | fr3_joint1           | Hinge  |  1 |  1 |    11 |   10
  6 | fr3_joint2           | Hinge  |  1 |  1 |    12 |   11
  7 | fr3_joint3           | Hinge  |  1 |  1 |    13 |   12
  8 | fr3_joint4           | Hinge  |  1 |  1 |    14 |   13
  9 | fr3_joint5           | Hinge  |  1 |  1 |    15 |   14
 10 | fr3_joint6           | Hinge  |  1 |  1 |    16 |   15
 11 | fr3_joint7           | Hinge  |  1 |  1 |    17 |   16

 id | name                 | trn     | target_joint
----+----------------------+---------+-------------
  0 | left_wheel           | Joint   | front_left_wheel
  1 | right_wheel          | Joint   | front_right_wheel
  2 | fr3_joint1           | Joint   | fr3_joint1
  3 | fr3_joint2           | Joint   | fr3_joint2
  4 | fr3_joint3           | Joint   | fr3_joint3
  5 | fr3_joint4           | Joint   | fr3_joint4
  6 | fr3_joint5           | Joint   | fr3_joint5
  7 | fr3_joint6           | Joint   | fr3_joint6
  8 | fr3_joint7           | Joint   | fr3_joint7
...
----+-----------------------------+----------+------------
  ...
  1 | d435_rgb                    | -        | 640x480
*/
    class FR3HuskyController final : public MujocoRosSim::ControllerInterface
    {
        public:
            FR3HuskyController() = default;
            // ====================================================================================
            // ================================== Core Functions ================================== 
            // ====================================================================================
        ...
        private:
            ...
            std::shared_ptr<FR3Husky::FR3HuskyRobotData> robot_data_;
